        ...
        <CardContent className="pt-4">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <p>
                В отличие от Bot API, MTProto позволяет отправлять сообщения от вашего личного аккаунта
                любым пользователям — даже тем, кто не подписан на бота. Достаточно знать их Telegram ID
                или @username.
              </p>
              <p>
